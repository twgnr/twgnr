...
| <img src="assets/projects/beyond-shopping.svg" width="160" alt="" /> | **Beyond Shopping** | Multi-tenant e-commerce SaaS, deployed per customer — trilingual storefront, product variants, coupons, reviews, Stripe/Mollie/PayPal checkout, and a fully theme-able design panel with no code required. `Next.js` · `React` · `MongoDB` |
